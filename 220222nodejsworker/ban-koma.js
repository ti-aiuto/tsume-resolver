...
exports.BanKoma = class BanKoma {
  ...
  asJson() {
    return {
      koma: { name: this.koma.name() },
      side: this.side.asJson(),
      banPoint: this.banPoint?.asJson(),
      nari: this.nari,
    };
  }
  ...
  static buildFromJson(json) {
    ...
    return new BanKoma(
      komaFactory.createKoma(json['koma']['name']),
      BanSide.buildFromJson(json['side']),
      json['banPoint'] ? BanPoint.buildFromJson(json['banPoint']) : null,
      json['nari'],
    );
  }
};
